...
cargo run --package preprocess_image -- /tmp/emoji-32x32.png "/tmp/$EMOJI_HEX.rgba"
echo "Generated image! Copying to raspi ..."
rsync --mkpath "/tmp/$EMOJI_HEX.rgba" "pi:~/img/$EMOJI_HEX.rgba"
# may require `brew install rsync`
